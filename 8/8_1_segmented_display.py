...
#Calm before the storm. A promise of things to come
...
7: 8
'''
#Deduce the key to unscramble the digits by matching segments
def generate_key(display_unit):
    ...
    decode_key_flipped = {v: k for k, v in decode_key.items()} #flip the dictionary keys with values for convenience
